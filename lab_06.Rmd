...
ggplot(mingo_county_pills_per_year) +
  ...
  labs(x="Year", y="Total pills", title="In Mingo County, opioids peak in 2008, then fall steadily through 2012", subtitle = "Total pills shipped to Baltimore City by year", caption = "Source: DEA ARCOS database, via Washington Post") +
  scale_x_continuous(breaks = c(2006, 2007, 2008, 2009, 2010, 2011, 2012)) +
  scale_y_continuous(labels = comma)

  # Also saves a web version
  ggsave("mingo_pills.jpg", plot=last_plot())
```
